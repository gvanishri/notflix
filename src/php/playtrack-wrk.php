	...
	*/
	...
	while($row = mysqli_fetch_assoc($resultSet1)) {
		...
		*/
		if ($UsrID == $row['UserAcctID'] && $TrackID == $row['TranTrackID']) {
			//echo "<tr style='background:white;'>";
			//echo $row['TranCurrTime'] ."<br>";
			$timeArr1 = explode("/",$row['TranCurrTime']);
			//echo $timeArr1[0] ."<br>";
			$timeArr2 = explode("-",$timeArr1[0]);
			//echo $timeArr2[1] ."<br>";
			//echo $timeArr2[2] ."<br>";
            $currTimeVal = $timeArr2[1];
			//echo $currTimeVal ."<br>";
			$timeArr2 = explode("-",$timeArr1[1]);
			//echo $timeArr2[1] ."<br>";
			//echo $timeArr2[2] ."<br>";
            $durTimeVal = $timeArr2[1];
			//echo $durTimeVal ."<br>";
		} else {
			//echo "<tr>";
		}
...
*/
if (trckInfo == "") {	
	trckInfo = "Action~" + usrtran.value + "|" + "TranCurrTime~" + "Start-" + formatTime(vid.currentTime) + "/" + "Duration-" + formatTime(vid.duration);
} else {
	trckInfo = trckInfo + "||" + "Action~" + usrtran.value + "|" + "TranCurrTime~" + "End-" + formatTime(vid.currentTime) + "/" + "Duration-" + formatTime(vid.duration);
}
//alert(trckInfo);
